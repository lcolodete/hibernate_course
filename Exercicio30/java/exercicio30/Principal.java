	...
	public static void main(String[] args)
	{
		...
		while (continua)
		{
			...
			case 1:
			{
				...
				umProduto = new Produto(id, nome, descricao, lanceMinimo, Util
			...
			case 4:
			{
				...
				try
				{
					umProduto = produtoAppService.recuperaUmProduto(numero);
				}
				catch (AplicacaoException e)
				{
					System.out.println('\n' + e.getMessage());
			...
			case 5:
			{
				List produtos = produtoAppService.recuperaProdutos();
