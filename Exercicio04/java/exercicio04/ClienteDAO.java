...
{	
	...
	{	Session sessao = null;
		...
		{	sessao = FabricaDeSessoes.criarSessao();
			...
			// Neste exemplo, o objeto persistente cliente está sendo 
			// removido do banco de dados. Após a remoção ele se torna um 
			// objeto transiente e, em seguida, é destruído pelo coletor 
			// de lixo.
