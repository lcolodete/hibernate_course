			...
			{	case 1:
				...
				{	
					...
					{	Lance lance = (Lance) it.next();
						System.out.println(	'\n' + 
							"  Numero do produto = " + lance.getId().getIdProduto() + 
							"  Numero do lance = " + lance.getId().getNumeroLance() + 
					...
					{	System.out.println("");
						...
						{	Produto produto = (Produto) it.next();
							...
							{	Lance lance = (Lance) it2.next();
								System.out.println(	'\n' + 
								  "  Produto N. " + lance.getId().getIdProduto() + 
								  "  Lance N. " + lance.getId().getNumeroLance() + 
								  "  valor = " + lance.getValor() +
								  "  Data = " + lance.getDataCriacaoMasc());
							}	
                    	} 
