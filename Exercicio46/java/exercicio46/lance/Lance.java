...
{	private Long id;
	...
	{	if (!Util.dataValida(dataCriacao))
		...
		{	throw new AplicacaoException("A data de emissão do lance não pode ser anterior a " + Util.dateToStr(dataUltimoLance));
		}

		Date hoje = new Date(System.currentTimeMillis());
		
		if(this.dataCriacao.after(hoje))
		{	throw new AplicacaoException("A data de emissão do lance nao pode ser posterior à data de hoje: " + Util.dateToStr(hoje));
		}
	}
