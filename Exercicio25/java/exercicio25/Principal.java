...
public class Principal
{
	public static void main(String[] args)
	{
		...
		while (continua)
		{
			...
			/* ==> */System.out
					.println("4. Recupera um pagamento efetuado atraves de cartao");
			/* ==> */System.out
					.println("5. Recupera um pagamento sem saber se foi feito por cartao ou conta");
			...
			case 1:
			{
				...
				String data = Console.readLine("Informe a data do pagamento: ");
				...
				case 1:
				{
					String numero = Console.readLine("Informe o numero do cartao: ");
					...
					// ==>
					pagamento = new Cartao(valor, dataPagto, numero, mesExp, anoExp);
					break;
				}
				...
				case 2:
				{
					...
					// ==>
					pagamento = new Conta(valor, dataPagto, banco, agencia, conta);
					break;
				}
			...
			case 2:
			{
				...
				if (umPagamento instanceof Conta)
				{
					System.out.println('\n' + "Pagamento numero = " + umPagamento.getId()
							+ "  Valor = " + umPagamento.getValor() + "  Banco = "
							+ ((Conta) umPagamento).getBanco());
				...
				{
					System.out.println('\n' + "Pagamento numero = " + umPagamento.getId()
							+ "  Valor = " + umPagamento.getValor() + "  Numero do Cartao = "
			...
			case 4:
			{
				...
				System.out.println('\n' + "Pagamento numero = "
						+ pagamentoEmCartao.getId() + "  Valor = "
						+ pagamentoEmCartao.getValor() + "  Numero do Cartao = "
						+ pagamentoEmCartao.getNumero());
			...
			case 5:
			{
				...
				if (pagamento instanceof Conta)
				{
					System.out.println('\n' + "Pagamento numero = " + pagamento.getId()
							+ "  Valor = " + pagamento.getValor() + "  Banco = "
							+ ((Conta) pagamento).getBanco());
				}
				else
				{
					System.out.println('\n' + "Pagamento numero = " + pagamento.getId()
							+ "  Valor = " + pagamento.getValor() + "  Numero do Cartao = "
			...
			case 6:
				// ==>
			{
				List pagamentos = pagamentoAppService.recuperaPagamentos();
