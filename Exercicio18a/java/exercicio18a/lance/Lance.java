...
import exercicio18a.produto.Produto;
...
{	private Long id;
	...
	{	
		...
		if(this.valor <= valorUltimoLance)
		{
			throw new AplicacaoException(
				"O valor do lance tem que ser superior a " + Util.doubleToStr(valorUltimoLance) + ".");
		}
	}
	...
	{	
		...
		{
			throw new AplicacaoException("Data de emissao inválida.");
		}
