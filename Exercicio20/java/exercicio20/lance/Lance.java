...
{	private Long id;
	...
	// private Produto produtoAdquirido;   //(Evite tornar bidirecionais as associações um-para-um)
	...
	{	if(dataCriacao.before(dataUltimoLance))
		...
		{	throw new AplicacaoException
				("A data de emissao do lance nao pode ser posterior `a data de hoje: " + 
					Util.dateToStr(hoje));
		}
...
/*  
 	Evite tornar bidirecionais as associações um-para-um
 	----------------------------------------------------
