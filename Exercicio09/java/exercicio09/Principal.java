...
{	public static void main (String[] args)
	{	
		...
		{	System.out.println('\n' + "O que voce deseja fazer?");
			...
			System.out.println("6. Listar até um determinado número");
			...
			{	case 1:
				...
				{	int resposta = Console.readInt('\n' + 
					...
					if (clienteDAO.atualizaSalario(resposta, 
					                               percentualDeAumento))
					{	System.out.println('\n' + 
				...
				case 6:
				{	long ultimo = Console.readInt(
						"Informe o número do último cliente a ser exibido: ");					

					List arrayClientes = clienteDAO
							.recuperaClientesAteDeterminadoNumero(ultimo);
