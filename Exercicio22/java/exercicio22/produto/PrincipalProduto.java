...
public class PrincipalProduto
{
	public static void main(String[] args)
	{
		...
		while (continua)
		{
			...
			out.println("3. Remover um produto");
			...
			out.println("");
			out.println("8. Informar uma nova categoria de um produto");
			...
			case 7:
			{
				...
				// Informar uma nova categoria de um produto
				/* ==> */case 8:
			{
				...
				/* ==> */case 10:
			{
				...
				Set produtoCategorias = umProduto.getProdutoCategorias();

				for (Iterator it = produtoCategorias.iterator(); it.hasNext();)
				{
