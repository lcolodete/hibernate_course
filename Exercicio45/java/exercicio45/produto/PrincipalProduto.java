...
import corejava.*;
import exercicio45.controleTransacao.FabricaDeAppService;
	...
	public static void main(String[] args)
	{
		...
		while (continua)
		{
			...
			case 1:
			{
				...
				lanceMinimo = Console.readLine("Informe o valor do lance minimo: ");
				dataCadastro = Console
						.readLine("Informe a data de cadastramento do produto: ");

				try
				{
					long numero = produtoAppService.inclui(nome, descricao, lanceMinimo,
							dataCadastro);
				...
				if (produtos.size() != 0)
				{
					...
					for (Iterator it = produtos.iterator(); it.hasNext();)
					{
						...
						System.out.println('\n' + "Produto numero = " + produto.getId()
								...
								+ produto.getLanceMinimoMasc() + "  Data Cadastro = "
								+ produto.getDataCadastroMasc());
