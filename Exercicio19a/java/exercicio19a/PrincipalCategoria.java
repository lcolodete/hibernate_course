	...
	public static void main(String[] args)
	{
		...
		while (continua)
		{
			...
			case 2:
			{
				...
				long idCategoriaPai = Console.readInt("Informe o numero da categoria pai: ");

				umaCategoria = new Categoria(nome);

				try
				{
					long numero = categoriaAppService.incluiCategoriaComoSubCategoria(
							umaCategoria, idCategoriaPai);
					System.out.println('\n' + "Categoria numero " + numero
							+ " incluida com sucesso!");
				}
			...
			case 3:
			{
				...
				try
				{
					if (categoriaAppService.adicionaSubCategoriaAUmaCategoria(
			...
			case 4:
			{
				int idCategoria = Console
						.readInt('\n' + "Digite o numero da categoria: ");

				int idSubCategoria = Console.readInt('\n'
						+ "Digite o numero da subcategoria que voce deseja " + "remover: ");

				try
				{
					if (categoriaAppService.removeSubCategoriaDeCategoria(idCategoria,
							idSubCategoria))
					{
						System.out.println("Subcategoria removida com sucesso.");
					}
					else
					{
						System.out.println("Subcategoria nao encontrada na categoria.");
					}
				}
				catch (AplicacaoException e)
				{
			...
			case 5:
			{
				...
				try
				{
					umaCategoria = categoriaAppService.recuperaUmaCategoria(resposta);
				}
				catch (AplicacaoException e)
				{
					System.out.println('\n' + e.getMessage());
			...
			case 6:
			{
				long numero = Console.readInt("Informe o numero da categoria: ");

				try
				{
					umaCategoria = categoriaAppService.recuperaUmaCategoriaESubCategorias(numero);
				}
				catch (AplicacaoException e)
				{
					System.out.println('\n' + e.getMessage());
				...
				for (Iterator it = categorias.iterator(); it.hasNext();)
				{
					...
					System.out.println("     Subcategoria numero = "
							+ subCategoria.getId() + "  Nome = " + subCategoria.getNome());
				}
			...
			case 7:
			{
				Set categorias = categoriaAppService.recuperaCategoriasESubCategorias();
				...
				if (categorias.size() != 0)
				{
					...
					for (Iterator it = categorias.iterator(); it.hasNext();)
					{
						...
						for (Iterator it2 = subCategorias.iterator(); it2.hasNext();)
						{
							Categoria subCategoria = (Categoria) it2.next();
							System.out
									.println('\n' + "      Subcategoria numero = "
											+ subCategoria.getId() + "  nome = "
